...
//      width: MediaQuery.of(context).size.width,
        decoration: BoxDecoration(
            ...
            image: DecorationImage(image: AssetImage('images/background_white.png'))),
        child: Stack(
          children: <Widget>[
            PageView(
              onPageChanged: (value) {
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Marketplace for unique/Handmade and creative goods ',
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Our mission to keep human connection at the heart of commerce',
                        textAlign: TextAlign.right,
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 32),
                      child: Text(
                        'Get Any Home Made Thing Online',
                        textAlign: TextAlign.right,
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16),
                      ),
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 32, vertical: 16.0),
                      child: Text(
                        'You can search anything ranging from digital products to Food within few clicks.',
                        textAlign: TextAlign.right,
                        style: TextStyle(color: Colors.grey, fontSize: 20.0),
                      ),
                    ),
